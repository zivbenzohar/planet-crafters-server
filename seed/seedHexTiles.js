...
const tiles = [
  ...
  // ========================= Category 2 — 4+2 Contiguous (AAAABB) (12) — Level 2 =========================
  { type: "moreRockCrystal",  edges: [R,R,R,R,C,C], level: 2 },
  { type: "moreRockBio",      edges: [R,R,R,R,B,B], level: 2 },
  { type: "moreRockTerra",    edges: [R,R,R,R,T,T], level: 2 },
  { type: "moreCrystalRock",  edges: [C,C,C,C,R,R], level: 2 },
  { type: "moreCrystalBio",   edges: [C,C,C,C,B,B], level: 2 },
  { type: "moreCrystalTerra", edges: [C,C,C,C,T,T], level: 2 },
  { type: "moreBioRock",      edges: [B,B,B,B,R,R], level: 2 },
  { type: "moreBioCrystal",   edges: [B,B,B,B,C,C], level: 2 },
  { type: "moreBioTerra",     edges: [B,B,B,B,T,T], level: 2 },
  { type: "moreTerraRock",    edges: [T,T,T,T,R,R], level: 2 },
  { type: "moreTerraCrystal", edges: [T,T,T,T,C,C], level: 2 },
  { type: "moreTerraBio",     edges: [T,T,T,T,B,B], level: 2 },

  // ========================= Category 3 — 4+2 Non-Contiguous A (AAABAB) (12) — Level 3 =========================
  { type: "altA_moreRockCrystal",  edges: [R,R,R,C,R,C], level: 3 },
  { type: "altA_moreRockBio",      edges: [R,R,R,B,R,B], level: 3 },
  { type: "altA_moreRockTerra",    edges: [R,R,R,T,R,T], level: 3 },
  { type: "altA_moreCrystalRock",  edges: [C,C,C,R,C,R], level: 3 },
  { type: "altA_moreCrystalBio",   edges: [C,C,C,B,C,B], level: 3 },
  { type: "altA_moreCrystalTerra", edges: [C,C,C,T,C,T], level: 3 },
  { type: "altA_moreBioRock",      edges: [B,B,B,R,B,R], level: 3 },
  { type: "altA_moreBioCrystal",   edges: [B,B,B,C,B,C], level: 3 },
  { type: "altA_moreBioTerra",     edges: [B,B,B,T,B,T], level: 3 },
  { type: "altA_moreTerraRock",    edges: [T,T,T,R,T,R], level: 3 },
  { type: "altA_moreTerraCrystal", edges: [T,T,T,C,T,C], level: 3 },
  { type: "altA_moreTerraBio",     edges: [T,T,T,B,T,B], level: 3 },

  // ========================= Category 4 — 4+2 Non-Contiguous B (AABAAB) (12) — Level 3 =========================
  { type: "altB_moreRockCrystal",  edges: [R,R,C,R,R,C], level: 3 },
  { type: "altB_moreRockBio",      edges: [R,R,B,R,R,B], level: 3 },
  { type: "altB_moreRockTerra",    edges: [R,R,T,R,R,T], level: 3 },
  { type: "altB_moreCrystalRock",  edges: [C,C,R,C,C,R], level: 3 },
  { type: "altB_moreCrystalBio",   edges: [C,C,B,C,C,B], level: 3 },
  { type: "altB_moreCrystalTerra", edges: [C,C,T,C,C,T], level: 3 },
  { type: "altB_moreBioRock",      edges: [B,B,R,B,B,R], level: 3 },
  { type: "altB_moreBioCrystal",   edges: [B,B,C,B,B,C], level: 3 },
  { type: "altB_moreBioTerra",     edges: [B,B,T,B,B,T], level: 3 },
  { type: "altB_moreTerraRock",    edges: [T,T,R,T,T,R], level: 3 },
  { type: "altB_moreTerraCrystal", edges: [T,T,C,T,T,C], level: 3 },
  { type: "altB_moreTerraBio",     edges: [T,T,B,T,T,B], level: 3 },
